...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rehype$2d$highlight$2f$lib$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/rehype-highlight/lib/index.js [app-client] (ecmascript)");
...
const UserForm = ()=>{
    ...
    const [questionNumber, setQuestionNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    ...
    const fetchQuestion = async (userDataOrAnswer)=>{
        try {
            ...
            if (questionNumber === 35) {
                ...
                const { questionNumber, question, options = [], feedbackForPreviousQuestion } = data.result;
...
_s(UserForm, "UDsAQ2pSMm+433V0szLu+cUDipQ=", false, function() {
    return [
